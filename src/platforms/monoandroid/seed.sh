...
dotnet ~/.nuget/packages/microsoft.dotnet.genapi/5.0.0-beta.19511.1/tools/netcoreapp2.1/Microsoft.DotNet.GenAPI.dll $SeedAssemblies --lib-path "/Library/Frameworks/Xamarin.Android.framework/Versions/Current/lib/xbuild-frameworks/MonoAndroid/v1.0/" --out $ScriptDir --exclude-attributes-list $ScriptDir/../attributeExcludeList.txt --header-file $ScriptDir/../../netstandard/ref/license-header.txt
