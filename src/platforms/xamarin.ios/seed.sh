...
dotnet ~/.nuget/packages/microsoft.dotnet.genapi/5.0.0-beta.19511.1/tools/netcoreapp2.1/Microsoft.DotNet.GenAPI.dll $SeedAssemblies --lib-path "/Library/Frameworks/Xamarin.iOS.framework/Versions/Current/lib/mono/Xamarin.iOS/" --out $ScriptDir --exclude-attributes-list $ScriptDir/../attributeExcludeList.txt --header-file $ScriptDir/../../netstandard/ref/license-header.txt
