...
+        public SerializationContents ViewStateContent { get; set; }
...
+        ZigZag = 54,
+    }
+    public class ChartHttpHandler : Page, IHttpHandler, IRequiresSessionState {
+        public ChartHttpHandler();
+        public static ChartHttpHandlerSettings Settings { get; }
...
+        public bool PrivateImages { get; }
+        public ChartHttpHandlerStorageType StorageType { get; set; }
...
+        OutsideArea = 1,
+    }
+    public class Title : ChartNamedElement, IChartMapArea, IDisposable {
+        public Title();
