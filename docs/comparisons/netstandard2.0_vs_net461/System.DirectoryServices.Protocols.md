...
+    }
+    public class DsmlRequestDocument : DsmlDocument, ICollection, IEnumerable, IList {
...
+        public DirectoryRequest this[int index] { get; set; }
...
+        bool System.Collections.ICollection.IsSynchronized { get; }
+        object System.Collections.ICollection.SyncRoot { get; }
+        public DirectoryResponse this[int index] { get; }
