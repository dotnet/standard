...
%~dp0..\..\Tools\dotnetcli\dotnet %~dp0..\..\Tools\GenAPI.exe -assembly "OpenTK-1.0.dll;Xamarin.iOS.dll" -libPath "%ProgramFiles(x86)%\Reference Assemblies\Microsoft\Framework\Xamarin.iOS\v1.0" -out %~dp0 -excludeAttributesList %~dp0..\attributeExcludeList.txt -headerFile %~dp0..\..\netstandard\ref\license-header.txt -excludeApiList %~dp0apiExcludeList.txt
